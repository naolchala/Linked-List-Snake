...
const game_display = $(".game") as HTMLDivElement;
const start_btn = $("#start") as HTMLButtonElement;
const restart_btn = $("#restart") as HTMLButtonElement;
const settings_btn = $("#setting") as HTMLButtonElement;
...
class LinkedList {
	...
	draw() {
		let temp: SnakeNode | undefined = this.head;
		while (temp != null) {
			temp.draw();
			temp = temp.next;
		}
